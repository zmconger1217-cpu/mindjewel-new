...
const footerLinks = {
  ...
  About: [
    ...
    { label: "Care Guide", href: "/trust#care" },
    ...
    <footer className="bg-brown text-cream/80">
      <div className="max-w-7xl mx-auto px-4 lg:px-8 py-16 lg:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          {/* Brand */}
          <div>
            <Link href="/" className="text-2xl font-serif tracking-[0.2em] text-cream">
              MINDJEWEL
            </Link>
            <p className="mt-4 text-sm leading-relaxed text-cream/60 max-w-xs">
              Jewelry that reflects who you are becoming. Light, bold, and effortlessly you.
            </p>
          ...
          {Object.entries(footerLinks).map(([title, links]) => (
            <div key={title}>
              <h3 className="text-sm tracking-widest uppercase text-cream/40 mb-4">{title}</h3>
        ...
        <div className="border-t border-cream/10 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-xs text-cream/40">© 2026 MINDJEWEL. All rights reserved.</p>
